...
RCT_EXPORT_METHOD(autoLogin:(nonnull NSString *)account token:(nonnull NSString *)token
                  forcedMode:(nonnull NSString *)forced resolve:(RCTPromiseResolveBlock)resolve
...
//XX
RCT_EXPORT_METHOD(sendCustomMessage:(nonnull  NSDictionary *)options){
    [[ConversationViewController initWithConversationViewController]sendCustomMessage:options];
}
RCT_EXPORT_METHOD(sendCardMessage:(nonnull  NSDictionary *)options){
    [[ConversationViewController initWithConversationViewController]sendCardMessage:options];
}
...
////X
////发送名片消息
//RCT_EXPORT_METHOD(sendCardMessage:(int)type name:(NSString *)name imgPath:(NSString *)imgPath sessionId:(NSString *)sessionId){
